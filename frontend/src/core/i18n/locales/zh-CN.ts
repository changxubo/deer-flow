...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用 🐒 Wukong Agent，一个完全开源的超级智能体。通过内置和自定义的 Skills，\nWukong Agent 可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n图片、视频、播客及网页等，几乎可以做任何事情。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来释放 Wukong Agent 的潜力。通过自定义技能，Wukong Agent\n可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n网页等作品，几乎可以做任何事情。",
  ...
  workspace: {
    ...
    githubTooltip: "访问Github仓库",
    settingsAndMore: "设置",
    visitGithub: "在Github上查看",
    reportIssue: "报告问题",
    contactUs: "联系我们",
    about: "关于",
  },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 Wukong 中使用",
  },
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 Wukong 的界面和行为。",
    sections: {
      appearance: "外观",
      language: "语言",
      memory: "记忆",
    ...
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 Wukong 根目录下的 `/skills/custom` 文件夹中。",
